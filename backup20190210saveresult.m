...
%run_save_more() %for phenomenological A, sumer simulation
update_plots()  %update
...
%G:  code1 simulation7, wrong syndrome filter
    ...
    switch file_version_flag
      ...
      case 5
        %phenomenological model B,  case/model e,g,f  only GA and GI code , saved in plots/phenomenological-model-B
      ...
      case 6
        ...
        file_version='-B-soft-1-3'; %waiting
        file_version_GR=file_version;
        file_version_GI=file_version;
        file_version_G=['-G',file_version];
        file_version_GA=file_version;
